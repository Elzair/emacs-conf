...
(defvar package-list '(ac-geiser ac-sly auto-complete cider clojure-mode clojure-test-mode clojurescript-mode dash evil evil-leader flycheck flycheck-pos-tip geiser goto-chg julia-mode load-theme-buffer-local magit markdown-mode neotree omnisharp org org-present popup punctuality-logger quack rainbow-delimiters sly smart-tab smartparens solarized-theme tern undo-tree)
