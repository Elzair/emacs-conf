...
(defvar package-list '(android-mode cider clojure-mode clojure-test-mode clojurescript-mode company company-c-headers company-irony company-tern dash dockerfile-mode emmet-mode evil evil-leader flycheck flycheck-pos-tip geiser goto-chg haskell-mode julia-mode load-theme-buffer-local magit markdown-mode neotree org org-present php-extras popup punctuality-logger quack rainbow-delimiters sly sly-company solarized-theme tern toml-mode undo-tree web-mode yaml-mode yasnippet)
