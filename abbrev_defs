...
(define-abbrev-table 'cfengine2-mode-abbrev-table '())

(define-abbrev-table 'cfengine3-mode-abbrev-table '())
...
(define-abbrev-table 'gnu-apl-documentation-mode-abbrev-table '())

(define-abbrev-table 'gnu-apl-documentation-search-mode-abbrev-table '())

(define-abbrev-table 'gnu-apl-interactive-mode-abbrev-table '())

(define-abbrev-table 'gnu-apl-keymap-mode-abbrev-table '())

(define-abbrev-table 'gnu-apl-mode-abbrev-table '())

(define-abbrev-table 'gnu-apl-trace-mode-abbrev-table '())
